...
{
    private const string ReceiverAttributeName = "GodotSimpleTools.ReceiverAttribute";
...
private static ReceiverMethodInfo? GetMethodInfo(GeneratorAttributeSyntaxContext context)
{
    ...
    return receiverInfos.Count == 0 
        ? null 
        : new ReceiverMethodInfo(containingType, methodSymbol.Name, receiverInfos);
}
...
private static string ExtractEventName(string raw)
{
        ...
        IReadOnlyList<ReceiverInfo> receivers)
    {
        ...
        public IReadOnlyList<ReceiverInfo> Receivers { get; } = receivers;
    }

    private sealed class ReceiverInfo(string eventName)
    {
